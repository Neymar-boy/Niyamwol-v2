...
module.exports = {
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/aqjv8k9.jpeg' : process.env.GAN_IMAGE,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? '  𝙽𝙸𝚈𝙰𝙼𝚆𝙾𝙻  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? 'ɴɪʏᴀᴍᴡᴏʟ ᴅᴏᴡɴʟᴏᴀᴅ ᴄʜᴇʏʏᴜɴɴᴜ' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? 'ɴɪʏᴀᴍᴡᴏʟ ᴜᴘʟᴏᴀᴅ ᴄʜᴇʏʏᴜɴɴᴜ' : process.env.SONGU,
    ...
    NIYA_AI: process.env.NIYA_AI === undefined ? 'false' : process.env.RUDHRA_AI,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '𝙽𝙸𝚈𝙰𝙼𝚆𝙾𝙻' : process.env.LOGO_NAME,
